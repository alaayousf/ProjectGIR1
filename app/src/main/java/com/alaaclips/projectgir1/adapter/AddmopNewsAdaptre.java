...
public class AddmopNewsAdaptre extends RecyclerView.Adapter<AddmopNewsAdaptre.VotingListViewHolde> {

    ArrayList<AddModnews> mData;
    Activity activity;


    public AddmopNewsAdaptre(ArrayList<AddModnews  > mData, Activity activity) {
        this.mData = mData;
    ...
    @NonNull
    @Override
    public AddmopNewsAdaptre.VotingListViewHolde onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.from(activity).inflate(R.layout.add_and_news,parent,false);
        return new AddmopNewsAdaptre.VotingListViewHolde(itemView);

    }


    @Override
    public void onBindViewHolder(@NonNull AddmopNewsAdaptre.VotingListViewHolde holder, int position) {
        holder.descreption.setText(mData.get(position).getDescreption());
...
//                .into(holder.ImmageView);

        Glide.with(activity).load("https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE4wwtq?ver=b3fb").into(holder.ImmageView);
    ...
    public class VotingListViewHolde extends RecyclerView.ViewHolder{
        ...
        public VotingListViewHolde(@NonNull View itemView) {
            super(itemView);
            ImmageView = itemView.findViewById(R.id.imageView2);
